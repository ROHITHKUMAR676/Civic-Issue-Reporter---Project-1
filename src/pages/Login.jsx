  ...
  return (
    ...
    bg-gradient-to-br from-indigo-900 via-slate-900 to-black">
      ...
      {animationDone && (
        ...
        backdrop-blur-lg bg-white/10 border border-white/20 shadow-2xl
        animate-fadeUp">
          ...
          <div className="flex items-center bg-white/20 rounded-lg px-3 py-2 mb-4">
            <HiMail className="text-white mr-2" />
            <input
              type="email"
              placeholder="Email"
          ...
          {/* Password */}
          <div className="flex items-center bg-white/20 rounded-lg px-3 py-2 mb-6">
            <HiLockClosed className="text-white mr-2" />
            <input
              type="password"
          ...
          <button
            ...
            bg-indigo-600 hover:bg-indigo-700 transition duration-300 text-white"
            onClick={handleLogin}
          >
    ...
    window.location.href = "http://localhost:5000/api/auth/google";
            ...
            bg-white text-gray-800 py-2 rounded-lg
