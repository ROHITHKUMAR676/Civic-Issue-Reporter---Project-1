...
function DeptDashboard() {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* HEADER */}
      <div>
        <h2 className="text-3xl font-bold">Department Command Center</h2>
      ...
      {/* 🔥 STATS */}
      <div className="bg-[#1e293b] rounded-2xl p-6 grid grid-cols-5 gap-6">
      ...
      <div className="bg-[#1e293b] rounded-2xl p-6">
        ...
        <div className="flex justify-between items-center mb-5">
          <h3 className="text-xl font-semibold">Priority Issues</h3>
        ...
        {issues.length === 0 ? (
          <p className="text-slate-400">No issues assigned yet.</p>
        ) : (
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            {issues.map((issue) => (
              ...
              <div
                ...
                className="bg-[#0f172a] rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition"
              >
